            ...
            <div className="w-card  shadow-card m-16">
             <HeroImg />
              <div key={i} className='p-8'>
                <h2 className='text-indigo-500 font-semibold text-2xl '>{event.name}</h2>
    ...
    <React.Fragment>
      <div className="">
        <div className="bg-pattern5 bg-cover w-full h-96 text-center p-16">
          <h1 className="font-semibold	text-tama text-4xl mt-20">
            Explore Public Events And See What Other Users Are Up To!{" "}
          </h1>
          <div className="pt-16 pl-16 pr-16 bg-tama m-36">
        ...
        <If condition={username}>
          ...
          <div className='pgination text-center m-auto'>
            ...
            <div className='flex flex-row	flex-wrap	justify-center items-center content-around '>{data}</div>
